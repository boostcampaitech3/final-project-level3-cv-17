...
data = dict(
    ...
    test=dict(
        ...
        pipeline=[
            ...
            dict(
                type='MultiScaleFlipAug',
                img_scale=[(1024, 1024), (512, 512), (2448, 3264)],
                flip=True,
...
log_level = 'INFO'
load_from = None
resume_from = '/opt/ml/input/final-project-level3-cv-17/SkyReplacement/SkySegmentation/mmseg_config/work_dirs/exp63/epoch_34.pth'
workflow = [('train', 1)]
